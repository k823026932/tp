...
mysqli_select_db($link,'acfun');




$sql="select * from codepay_user where user='$user'";
//var_dump($sql);die;
...
if($res && mysqli_affected_rows($link)){
    ...
    $sql2="insert into codepay_user(user) values('$user')";
  // var_dump($sql2);die;
    ...
    <section class="clearfix g-member">
        <div class="g-Recharge">
            <ul id="ulOption">
                ...
                <li money="0.02"><a href="javascript:;">0.02元<s></s></a></li>
                <li money="0.03"><a href="javascript:;" class="z-sel">0.03元<s></s></a></li> <!--class="z-sel" 表示默认选中50元-->
                <li money="0.04"><a href="javascript:;">0.04元<s></s></a></li>
                <li money="0.05"><a href="javascript:;">0.05元<s></s></a></li>
                <li money="0.06"><a href="javascript:;">0.06元<s></s></a></li>
            </ul>
        </div>
